...
ZEXTERN int ZEXPORT inflateBackInit_(z_streamp strm, int windowBits,
                                     ...
                                     int stream_size);
#ifdef Z_PREFIX_SET
#  define jkbotti_deflateInit(strm, level) \
          deflateInit_((strm), (level), ZLIB_VERSION, (int)sizeof(z_stream))
#  define jkbotti_inflateInit(strm) \
          inflateInit_((strm), ZLIB_VERSION, (int)sizeof(z_stream))
#  define jkbotti_deflateInit2(strm, level, method, windowBits, memLevel, strategy) \
          deflateInit2_((strm),(level),(method),(windowBits),(memLevel),\
                        (strategy), ZLIB_VERSION, (int)sizeof(z_stream))
#  define jkbotti_inflateInit2(strm, windowBits) \
          inflateInit2_((strm), (windowBits), ZLIB_VERSION, \
                        (int)sizeof(z_stream))
#  define jkbotti_inflateBackInit(strm, windowBits, window) \
