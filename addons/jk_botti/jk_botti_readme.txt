...
Values:
 ...
 1 - Always shoot visible breakables. (default)
 2 - Only shoot breakables that block the bot's movement path.
     Bot traces toward its current waypoint and only targets breakables
     in the way. Decorative breakables (ceiling lights, side windows)
     are ignored.
