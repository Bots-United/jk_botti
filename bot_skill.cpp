...
bot_skill_settings_t default_skill_settings[5] = {
   ...
   { 5, 0.10, 0.25, 10.0, 50.0, 80, 
     ...
     0.1, 0.3,
     150.0, 12.5, 0.120, 4.0, 0.05,
     1.5, TRUE, 50, 75, 50, 100,
   ...
   { 15, 0.25, 0.5, 8.0, 30.0, 70,
     ...
     0.2, 0.5,
     175.0, 20.0, 0.180, 3.0, 0.075,
     1.25, TRUE, 35, 60, 35, 90,
   ...
   { 50, 0.50, 0.75, 6.0, 15.0, 60,
     ...
     0.3, 0.7,
     200.0, 25.0, 0.240, 2.0, 0.1,
     1.0, TRUE, 20, 40, 20, 70,
   ...
   { 100, 1.0, 1.5, 4.0, 5.0, 50,
     ...
     0.6, 1.4,
     250.0, 30.0, 0.300, 1.25, 0.15,
     0.75, TRUE, 10, 25, 10, 40,
